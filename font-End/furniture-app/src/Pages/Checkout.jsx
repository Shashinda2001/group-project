...
const Product = ({ name, image, price, onIncrease, onDecrease, quantity }) => (
  <div style={{ margin: "10px", padding: "10px" }} className="product">
    ...
    <td className="increse_degrese_qu">
      <button onClick={onIncrease} className="increse">
        +
      </button>
      <h3> {quantity}</h3>
      <button onClick={onDecrease} className="decrese">
        -
      </button>
    </td>
  ...
  const [products, setProducts] = useState([
    {
      ...
      image:
        " https://m.media-amazon.com/images/I/81d90JW-LfL.__AC_SX300_SY300_QL70_FMwebp_.jpg",
      price: 40,
      quantity: 1,
    },
    {
      ...
      image:
        "https://m.media-amazon.com/images/I/91FH47-BbwL.__AC_SX300_SY300_QL70_FMwebp_.jpg",
      price: 50,
      quantity: 2,
    },
    {
      ...
      image:
        "https://m.media-amazon.com/images/I/61d2rgoL4CL.__AC_SX300_SY300_QL70_FMwebp_.jpg",
      price: 78,
      quantity: 1,
    },
    {
      ...
      image:
        "https://m.media-amazon.com/images/I/71mJ-owgDlL.__AC_SX300_SY300_QL70_FMwebp_.jpg",
      price: 76,
      quantity: 1,
    },
    {
      ...
      <div className="main_container">
        ...
        <div className="totel_details">
          <div className="totel_prize">
            ...
            <button className="btn1" onClick={redirectToAnotherWebsite}>
              CheckOut
            </button>
          </div>
        </div>
